...
export interface Flavor {
  ...
  image?: (number | null) | Media;
  /**
   * Price in cents (e.g. 350 = $3.50). Must match your Square catalog price.
   */
  priceCents: number;
  /**
...
export interface Order {
  ...
  items: {
    ...
    /**
     * Name at time of order (preserved if flavor is later edited or deleted)
     */
    flavorNameSnapshot?: string | null;
    quantity: number;
    priceAtOrderCents: number;
    id?: string | null;
  }[];
  subtotalCents: number;
  totalCents: number;
  pickupType: 'same-day' | 'next-day';
  pickupDate: string;
  /**
   * Human-readable slot, e.g. "7:00 AM"
   */
  pickupTime: string;
  status: 'pending' | 'paid' | 'ready' | 'picked-up' | 'cancelled' | 'refunded';
  /**
   * Square Payment ID returned after successful charge.
   */
  squarePaymentId?: string | null;
  /**
   * Note the customer left when ordering.
   */
...
/**
 * Weekly operating hours. "Sold out daily" message lives here too.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Hour {
  ...
  schedule?:
    | {
        ...
        /**
         * e.g. "until sold out" or "12:00 PM"
         */
...
export interface Location {
  id: number;
  /**
   * Name of the host location / parking lot where the trailer is set up.
   */
  ...
  zip: string;
  /**
   * Paste a Google Maps link for the "Get directions" button.
   */
  googleMapsUrl?: string | null;
  /**
   * Optional — e.g. "Look for the pink trailer near the entrance."
   */
...
export interface ContactLink {
  id: number;
  /**
   * Facebook Messenger m.me link for DM orders.
   */
  messengerUrl?: string | null;
  /**
   * Phone number for SMS orders, e.g. "210-336-0450".
   */
...
/**
 * Site-wide branding + kill-switches for online ordering.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface SiteSetting {
  ...
  /**
   * Hex color, e.g. #f472b6 (pink).
   */
  primaryColor?: string | null;
  /**
   * Hex color, e.g. #fbbf24 (amber).
   */
   ...
   */
  sameDayCutoffMinutesBeforeClose?: number | null;
  updatedAt?: string | null;
  createdAt?: string | null;
}
/**
...
export interface SiteSettingsSelect<T extends boolean = true> {
  ...
  accentColor?: T;
  orderingEnabled?: T;
  sameDayCutoffMinutesBeforeClose?: T;
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
}
